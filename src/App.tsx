            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 grid-rows-2 gap-4 h-auto lg:h-[550px]">
              ...
              >
                <motion.img 
                  animate="rest"
                  variants={{
                    rest: { scale: 1.0, transition: { duration: 2.8, ease: [0.16, 1, 0.3, 1] } },
                    hover: { scale: 1.12, transition: { duration: 2.2, ease: [0.16, 1, 0.3, 1] } },
                    tap: { scale: 1.18, transition: { duration: 2.5, ease: [0.16, 1, 0.3, 1] } }
                  }}
              ...
              <motion.div 
                ...
                whileTap={{ scale: 0.97, transition: { duration: 0.4, ease: "easeOut" } }}
                transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
